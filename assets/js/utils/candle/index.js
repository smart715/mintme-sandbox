...
data = data.map(function(v) {
  ...
  function getCandleYAxis(args) {
    ...
    return [
        ...
        {scale: scale, gridIndex: gridIndex, splitNumber: splitNumber, axisLine: axisLine, axisTick: axisTick, splitLine: splitLine, axisLabel: axisLabel},
    ];
  }
...
volumes.push(row[columns.indexOf(volumeMetrics)]);
    ...
    let legend$$1 = legendVisible && getCandleLegend({showMA: showMA, MA: MA, legendName: legendName, labelMap: labelMap});
    let tooltip$$1 = tooltipVisible && getCandleTooltip({metrics: metrics, dataType: dataType, digit: digit, labelMap: labelMap});
    let visualMap$$1 = showVol && getCandleVisualMap({downColor: downColor, upColor: upColor, MA: MA, showMA: showMA});
  ...
  let Loading = {render: function render() {
      let _vm = this; let _h = _vm.$createElement; let _c = _vm._self._c || _h; return _c('div', {staticClass: 'v-charts-component-loading'}, [_c('div', {staticClass: 'loader'}, [_c('div', {staticClass: 'loading-spinner'}, [_c('svg', {staticClass: 'circular', attrs: {'viewBox': '25 25 50 50'}}, [_c('circle', {staticClass: 'path', attrs: {'cx': '50', 'cy': '50', 'r': '20', 'fill': 'none'}})])])])]);
    }, staticRenderFns: [],
  };

  let DataEmpty = {render: function render() {
      let _vm = this; let _h = _vm.$createElement; let _c = _vm._self._c || _h; return _c('div', {staticClass: 'v-charts-data-empty'}, [_vm._v(' 暂无数据 ')]);
    }, staticRenderFns: [],
  };
