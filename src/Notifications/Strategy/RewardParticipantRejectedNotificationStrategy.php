...
class RewardParticipantRejectedNotificationStrategy implements NotificationStrategyInterface
{
    ...
    public function sendNotification(User $user): void
    {
        ...
        $this->mailer->sendRewardParticipantRejectedMail($user, $rewardToken, $rewardTitle, $slug);
    }
}
