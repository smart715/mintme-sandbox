...
class RewardVolunteerRejectedNotificationStrategy implements NotificationStrategyInterface
{
    ...
    public function sendNotification(User $user): void
    {
        ...
        $this->mailer->sendRewardVolunteerRejectedMail($user, $rewardToken, $rewardTitle, $slug);
    }
}
