...
class RewardVolunteerAcceptedNotificationStrategy implements NotificationStrategyInterface
{
    ...
    public function sendNotification(User $user): void
    {
        ...
        $this->mailer->sendRewardVolunteerAcceptedMail($user, $rewardToken, $rewardTitle, $slug);
    }
}
