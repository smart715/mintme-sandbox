...
class Profile
{
   ...
   * @Assert\Callback
   */
    public function validateFirstName(ExecutionContextInterface $context, $payload = null): void
    {
  ...
  * @Assert\Callback
  */
    public function validateLastName(ExecutionContextInterface $context, $payload = null): void
    {
