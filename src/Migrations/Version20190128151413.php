 ...
 */
final class Version20190128151413 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE token ADD created_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE profile_id profile_id INT DEFAULT NULL, CHANGE address address VARCHAR(255) DEFAULT NULL, CHANGE website_url website_url VARCHAR(255) DEFAULT NULL, CHANGE facebook_url facebook_url VARCHAR(255) DEFAULT NULL, CHANGE youtube_channel_id youtube_channel_id VARCHAR(255) DEFAULT NULL, CHANGE website_confirmation_token website_confirmation_token VARCHAR(180) DEFAULT NULL');
