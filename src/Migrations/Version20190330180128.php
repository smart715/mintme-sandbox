 ...
 */
final class Version20190330180128 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE lock_in CHANGE token_id token_id INT DEFAULT NULL, CHANGE amount_to_release amount_to_release VARCHAR(255) NOT NULL, CHANGE frozen_amount frozen_amount VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE lock_in CHANGE token_id token_id INT DEFAULT NULL, CHANGE amount_to_release amount_to_release BIGINT NOT NULL, CHANGE frozen_amount frozen_amount BIGINT NOT NULL');
        $this->addSql('ALTER TABLE media__gallery_media CHANGE gallery_id gallery_id INT DEFAULT NULL, CHANGE media_id media_id INT DEFAULT NULL');
