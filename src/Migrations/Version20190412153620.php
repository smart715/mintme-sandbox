 ...
 */
final class Version20190412153620 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE pending_withdraw ADD crypto_id INT DEFAULT NULL, DROP type, DROP crypto, DROP address, DROP status, CHANGE user_id user_id INT DEFAULT NULL, CHANGE date date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE amount amount VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE pending_withdraw ADD CONSTRAINT FK_321D93BBE9571A63 FOREIGN KEY (crypto_id) REFERENCES crypto (id)');
        $this->addSql('CREATE INDEX IDX_321D93BBE9571A63 ON pending_withdraw (crypto_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE news__post CHANGE image_id image_id INT DEFAULT NULL, CHANGE author_id author_id INT DEFAULT NULL, CHANGE collection_id collection_id INT DEFAULT NULL, CHANGE publication_date_start publication_date_start DATETIME DEFAULT \'NULL\', CHANGE comments_close_at comments_close_at DATETIME DEFAULT \'NULL\', CHANGE comments_count comments_count INT DEFAULT NULL');
        $this->addSql('ALTER TABLE pending_withdraw DROP FOREIGN KEY FK_321D93BBE9571A63');
        $this->addSql('DROP INDEX IDX_321D93BBE9571A63 ON pending_withdraw');
        $this->addSql('ALTER TABLE pending_withdraw ADD type VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, ADD crypto VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, ADD address VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, ADD status VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, DROP crypto_id, CHANGE user_id user_id INT DEFAULT NULL, CHANGE date date DATETIME NOT NULL, CHANGE amount amount NUMERIC(10, 0) NOT NULL');
