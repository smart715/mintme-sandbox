 ...
 */
final class Version20190430191310 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE crypto ADD show_subunit INT NOT NULL');
        ...
        $this->addSql('UPDATE crypto SET show_subunit = 4');
        $this->addSql('UPDATE crypto SET show_subunit = 8 WHERE symbol = "BTC"');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE classification__tag CHANGE context context INT DEFAULT NULL');
        $this->addSql('ALTER TABLE cron_report CHANGE job_id job_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE crypto DROP show_subunit');
