 ...
 */
final class Version20210127172903 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE phone_number (id INT AUTO_INCREMENT NOT NULL, profile_id INT DEFAULT NULL, phone_number VARCHAR(35) NOT NULL COMMENT \'(DC2Type:phone_number)\', verification_code VARCHAR(6) DEFAULT NULL, verified TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_6B01BC5B6B01BC5B (phone_number), UNIQUE INDEX UNIQ_6B01BC5BCCFA12B8 (profile_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
