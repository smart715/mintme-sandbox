 ...
 */
final class Version20190519191041 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX assignment_unique ON blacklist (type, value)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX assignment_unique ON blacklist');
