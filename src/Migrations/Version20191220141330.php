 ...
 */
final class Version20191220141330 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE api__access_token ADD CONSTRAINT FK_44940A4D19EB6921 FOREIGN KEY (client_id) REFERENCES api__client (id)');
        ...
        $this->addSql('ALTER TABLE api__refresh_token ADD CONSTRAINT FK_8CB9C30519EB6921 FOREIGN KEY (client_id) REFERENCES api__client (id)');
        ...
        $this->addSql('ALTER TABLE api__auth_code ADD CONSTRAINT FK_D3050D2019EB6921 FOREIGN KEY (client_id) REFERENCES api__client (id)');
