 ...
 */
final class Version20190925151108 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE market_status CHANGE crypto_id crypto_id INT DEFAULT NULL, CHANGE quote_token_id quote_token_id INT DEFAULT NULL, CHANGE quote_crypto_id quote_crypto_id INT DEFAULT NULL, CHANGE month_volume month_volume VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE knowledge_base CHANGE category_id category_id INT DEFAULT NULL, CHANGE subcategory_id subcategory_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE lock_in CHANGE token_id token_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE market_status CHANGE crypto_id crypto_id INT DEFAULT NULL, CHANGE quote_token_id quote_token_id INT DEFAULT NULL, CHANGE quote_crypto_id quote_crypto_id INT DEFAULT NULL, CHANGE month_volume month_volume VARCHAR(255) DEFAULT \'\'0\'\' NOT NULL COLLATE utf8mb4_unicode_ci');
        $this->addSql('ALTER TABLE media__gallery_media CHANGE gallery_id gallery_id INT DEFAULT NULL, CHANGE media_id media_id INT DEFAULT NULL');
