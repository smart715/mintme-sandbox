 ...
 */
final class Version20190729093326 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE knowledge_base (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, subcategory_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, short_url VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, INDEX IDX_AF81B45512469DE2 (category_id), INDEX IDX_AF81B4555DC6FE57 (subcategory_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
