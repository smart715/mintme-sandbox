...
class OrderNotificationStrategyTest extends TestCase
{
    ...
    private function createNotification(bool $isAvailable, string $channel): OrderNotificationStrategy
    {
        $token = $this->mockToken();
        $extraData = ['tokenName' => self::TOKEN_NAME];

        return new OrderNotificationStrategy(
